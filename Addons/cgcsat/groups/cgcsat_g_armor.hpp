            class ArmoredCWP {
                ...
                class O_cg_cwp_TankPlatoon {
                    ...
                    class Unit0 {
                        side=0;
                        vehicle="O_cg_cwp_MBT_02_cannon_F";
                        rank="LIEUTENANT";
                        position[]={0,0,0};
                    };
                ...
                class O_cg_cwp_TankPlatoon_AA {
                    ...
                    class Unit1 {
                        side=0;
                        vehicle="O_cg_cwp_APC_Tracked_02_AA_F";
                        rank="SERGEANT";
                        position[]={20,-30,0};
                    };
                ...
                class O_cg_cwp_SPGPlatoon_Scorcher {
                    ...
                    class Unit0 {
                        side=0;
                        vehicle="O_cg_cwp_MBT_02_arty_F";
                        rank="LIEUTENANT";
                        position[]={0,0,0};
                    };
            ...
            class ArmoredCDP {
                ...
                class O_cg_cdp_TankPlatoon {
                    ...
                    class Unit0 {
                        side=0;
                        vehicle="O_cg_cdp_MBT_02_cannon_F";
                        rank="LIEUTENANT";
                        position[]={0,0,0};
                    };
                ...
                class O_cg_cdp_TankPlatoon_AA {
                    ...
                    class Unit1 {
                        side=0;
                        vehicle="O_cg_cdp_APC_Tracked_02_AA_F";
                        rank="SERGEANT";
                        position[]={20,-30,0};
                    };
                ...
                class O_cg_cdp_SPGPlatoon_Scorcher {
                    name="$STR_A3_CfgGroups_West_BLU_F_Armored_BUS_SPGPlatoon_Scorcher0";
                    side=0;
                    faction="O_cgcsat";
                    ...
                    class Unit0 {
                        side=0;
                        vehicle="O_cg_cdp_MBT_02_arty_F";
                        rank="LIEUTENANT";
                        position[]={0,0,0};
                    };
                ...
                class O_cg_cdp_SPGSection_Scorcher {
                    name="$STR_A3_CfgGroups_West_BLU_F_Armored_BUS_SPGSection_Scorcher0";
                    side=0;
                    faction="O_cgcsat";
