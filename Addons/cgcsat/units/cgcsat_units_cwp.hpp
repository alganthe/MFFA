...
////////////////////////////////////////////////////Men
    ...
    {
        side=0;
        backpack = "B_cg_Caryall_cwp_Ammo";
        faction="O_cgcsat";
        vehicleclass="MenCWP";
        ...
        scope=2;
        scopeCurator = 2;
        linkedItems[] = {"V_HarnessO_gry","cg_MICH_cwp","ItemMap","ItemCompass","ItemWatch","ItemRadio","NVGoggles_OPFOR"};
        respawnLinkedItems[] = {"V_HarnessO_gry","cg_MICH_cwp","ItemMap","ItemCompass","ItemWatch","ItemRadio","NVGoggles_OPFOR"};
        class eventhandlers;
        class Wounds
        {
    ...
    {
        side=0;
        backpack = "B_cg_AssaultPack_cwp_AR";
        faction="O_cgcsat";
        vehicleclass="MenCWP";
        author= ECSTRING(main,author);
    ...
    {
        side=0;
        backpack = "B_cg_FieldPack_cwp_Medic";
        faction="O_cgcsat";
        vehicleclass="MenCWP";
        author= ECSTRING(main,author);
    ...
    {
        side=0;
        backpack ="B_cg_Carryall_cwp_eng";
        faction="O_cgcsat";
        vehicleclass="MenCWP";
        author= ECSTRING(main,author);
    ...
    {
        side=0;
        backpack ="B_cg_Carryall_cwp_exp";
        faction="O_cgcsat";
        vehicleclass="MenCWP";
        author= ECSTRING(main,author);
    ...
    class O_cg_cwp_Soldier_GL_F: O_Soldier_GL_F
    {
        ...
        scope=2;
        scopeCurator = 2;
        linkedItems[] = {"V_HarnessOGL_gry","cg_MICH_cwp","ItemMap","ItemCompass","ItemWatch","ItemRadio","NVGoggles_OPFOR"};
        respawnLinkedItems[] = {"V_HarnessOGL_gry","cg_MICH_cwp","ItemMap","ItemCompass","ItemWatch","ItemRadio","NVGoggles_OPFOR"};
        class eventhandlers;
    }; 
    ...
    {
        side=0;
        backpack ="B_cg_FieldPack_cwp_AA";
        faction="O_cgcsat";
        vehicleclass="MenCWP";
        author= ECSTRING(main,author);
    ...
    {
        side=0;
        backpack ="B_cg_FieldPack_cwp_AT";
        faction="O_cgcsat";
        vehicleclass="MenCWP";
        author= ECSTRING(main,author);
    ...
    {
        side=0;
        backpack ="B_cg_FieldPack_cwp_repair";
        faction="O_cgcsat";
        vehicleclass="MenCWP";
        author= ECSTRING(main,author);
    ...
    {
        side=0;
        backpack ="B_cg_FieldPack_cwp_LAT";
        faction="O_cgcsat";
        vehicleclass="MenCWP";
        author= ECSTRING(main,author);
    ...
    class o_cg_cwp_soldier_unarmed_f: o_soldier_unarmed_f
    {
        ...
        scope=2;
        scopeCurator = 2;
        linkedItems[] = {"V_HarnessO_gry","cg_MICH_cwp","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
        respawnLinkedItems[] = {"V_HarnessO_gry","cg_MICH_cwp","ItemMap","ItemCompass","ItemWatch","ItemRadio"};
        class eventhandlers;
    }; 
    ...
    class O_cg_cwp_Soldier_TL_F: O_Soldier_TL_F
    {
        ...
        scope=2;
        scopeCurator = 2;
        linkedItems[] = {"V_HarnessOGL_gry","cg_MICH_cwp","ItemGPS","ItemMap","ItemCompass","ItemWatch","ItemRadio","NVGoggles_OPFOR"};
        respawnlinkedItems[] = {"V_HarnessOGL_gry","cg_MICH_cwp","ItemGPS","ItemMap","ItemCompass","ItemWatch","ItemRadio","NVGoggles_OPFOR"};
        class eventhandlers;
    }; 
...
////////////////////////////////////////////////////Men(Sniper)
    class O_cg_sniper_F: O_sniper_F
    {
        side=0;
        faction="O_cgcsat";
        ...
        hiddenSelections[] = {"camo","insignia"};
        hiddenSelectionsTextures[] = {PATHTOF(data\cg_uniform_cwp.paa)};
        linkedItems[] = {"V_Chestrig_oli","TRYK_H_ghillie_over","ItemGPS","ItemMap","ItemCompass","ItemWatch","ItemRadio","NVGoggles_OPFOR"};
        respawnLinkedItems[] = {"V_Chestrig_oli","TRYK_H_ghillie_over","ItemGPS","ItemMap","ItemCompass","ItemWatch","ItemRadio","NVGoggles_OPFOR"};
        scope=2;
        scopeCurator = 2;
        class eventhandlers;
    }; 
    class O_cg_ghillie_ard_F: O_ghillie_ard_F
    {
        side=0;
        faction="O_cgcsat";
        vehicleclass="MenSniper";
        author= ECSTRING(main,author);
        _generalMacro="O_cg_ghillie_ard_F";
        scope=2;
        scopeCurator = 2;
        class eventhandlers;
    }; 
    class O_cg_ghillie_lsh_F: O_ghillie_lsh_F
    {
        side=0;
        faction="O_cgcsat";
        vehicleclass="MenSniper";
        author= ECSTRING(main,author);
        _generalMacro="O_cg_ghillie_lsh_F";
        scope=2;
        scopeCurator = 2;
        class eventhandlers;
    }; 
    class O_cg_ghillie_sard_F: O_ghillie_sard_F
    {
        side=0;
        faction="O_cgcsat";
        vehicleclass="MenSniper";
        author= ECSTRING(main,author);
        _generalMacro="O_cg_ghillie_sard_F";
        scope=2;
        scopeCurator = 2;
        class eventhandlers;
    }; 
    class O_cg_spotter_F: O_spotter_F
    {
        side=0;
        faction="O_cgcsat";
        vehicleclass="MenSniper";
        author= ECSTRING(main,author);
        _generalMacro="O_cg_spotter_F";
        uniformClass="O_cg_cwp_uniform1";
        model = "\A3\characters_F\BLUFOR\b_soldier_01.p3d";
        hiddenSelections[] = {"camo","insignia"};
        hiddenSelectionsTextures[] = {PATHTOF(data\cg_uniform_cwp.paa)};
...
////////////////////////////////////////////////////Men (Recon)
    ...
    {
        side=0;
        backpack = "B_cg_FieldPack_cwp_ReconExp";
        faction="O_cgcsat";
        ...
        scope=2;
        scopeCurator = 2;
        linkedItems[] = {"V_HarnessO_gry","cg_MICH_cwp","ItemGPS","ItemMap","ItemCompass","ItemWatch","ItemRadio","NVGoggles_OPFOR"};
        respawnLinkedItems[] = {"V_HarnessO_gry","cg_MICH_cwp","ItemGPS","ItemMap","ItemCompass","ItemWatch","ItemRadio","NVGoggles_OPFOR"};
        class eventhandlers;
    }; 
    ...
    {
        side=0;
        backpack = "B_cg_FieldPack_cwp_ReconMedic";
        faction="O_cgcsat";
        vehicleclass="MenReconCWP";
        author= ECSTRING(main,author);
...
////////////////////////////////////////////////////Men (Support)
    ...
    {
        side=0;
        backpack = "B_cg_Carryall_cwp_AAR";
        faction="O_cgcsat";
    ...
    {
        side=0;
        backpack = "B_cg_Carryall_cwp_AAA";
        faction="O_cgcsat";
        vehicleclass="MenSupportCWP";
        author= ECSTRING(main,author);
    ...
    {
        side=0;
        backpack = "B_cg_Carryall_cwp_AAT";
        faction="O_cgcsat";
        vehicleclass="MenSupportCWP";
        author= ECSTRING(main,author);
...
////////////////////////////////////////////////////Static
    ...
    class O_cg_Static_Designator_02_F: O_Static_Designator_02_F
    {
        displayname = "Remote Designator [CSAT]";
        faction="O_cgcsat";
        _generalMacro="O_cg_Static_Designator_02_F";
        author= ECSTRING(main,author);
        class eventhandlers;
    };
    ...
    class O_cg_GMG_01_A_F: O_GMG_01_A_F
    {
        author= ECSTRING(main,author);
        displayName = "XM307A";
        faction="O_cgcsat";
        _generalMacro="O_cg_GMG_01_A_F";
        class eventhandlers;
    };
    ...
    class O_cg_HMG_01_A_F: O_HMG_01_A_F
    {
        displayName = "XM312A";
        vehicleclass="Static";
        side=0;
        ...
        scopeCurator = 2;
        faction="O_cgcsat";
        _generalMacro="O_cg_HMG_01_A_F";
        author= ECSTRING(main,author);
        class eventhandlers;
    };
////////////////////////////////////////////////////Divers
    class O_cg_diver_F: O_diver_F       
    {
        author= ECSTRING(main,author);
        faction="O_cgcsat";
        _generalMacro="O_cg_diver_F";
        class eventhandlers;
    };
    class O_cg_diver_exp_F: O_diver_exp_F
    {
        author= ECSTRING(main,author);
        faction="O_cgcsat";
        _generalMacro="O_cg_diver_exp_F";
        class eventhandlers;
    };
    class O_cg_diver_TL_F: O_diver_TL_F
    {
        author= ECSTRING(main,author);
        faction="O_cgcsat";
        _generalMacro="O_cg_diver_TL_F";
        class eventhandlers;
    };