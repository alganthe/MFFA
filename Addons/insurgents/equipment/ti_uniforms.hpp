    ...
    class I_TRYK_U_taki_BLK: Uniform_Base
	{
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
		...
		{
			uniformModel = "-";
			uniformClass = I_ti_CL_F;
			containerClass = "Supply40";
			mass = 40;
		};
	};
    class I_TRYK_U_taki_COY: Uniform_Base
	{
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
	...
	class ItemInfo: UniformItem
		{
			uniformModel = "-";
			uniformClass = I_ti_SL_F;
			containerClass = "Supply40";
			mass = 40;
		};
	};
    class I_TRYK_U_taki_G_WH: Uniform_Base
    {
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
	...
	class ItemInfo: UniformItem
		{
			uniformModel = "-";
			uniformClass = I_ti_driver_F;
			containerClass = "Supply40";
			mass = 40;
		};
	};
    class I_B_takisp_G_BL_F: Uniform_Base
    {
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
	...
	class ItemInfo: UniformItem
		{
			uniformModel = "-";
			uniformClass = I_ti_eng_F;
			containerClass = "Supply40";
			mass = 40;
		};
	};   
	class I_TRYK_ZARATAKI: Uniform_Base
	{
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
		...
		{
			uniformModel = "-";
			uniformClass = I_ti_soldier_F;
			containerClass = "Supply40";
			mass = 40;
		};
	};
    class I_TRYK_ZARATAKI2: Uniform_Base
	{
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
		...
		{
			uniformModel = "-";
			uniformClass = I_ti_m_F;
			containerClass = "Supply40";
			mass = 40;
		};
	};
	class I_TRYK_ZARATAKI3: Uniform_Base
	{
        scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
		...
		{
			uniformModel = "-";
			uniformClass = I_ti_gl_F;
			containerClass = "Supply40";
			mass = 40;
		};    
    };
///////////////////////////////////////////////////////////////
    class O_TRYK_U_taki_BLK: Uniform_Base
	{
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
    ...
    class O_TRYK_U_taki_COY: Uniform_Base
	{
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
    ...
    class O_TRYK_U_taki_G_WH: Uniform_Base
    {
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
    ...
    class O_B_takisp_G_BL_F: Uniform_Base
    {
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
	...
	class O_TRYK_ZARATAKI: Uniform_Base
	{
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
    ...
    class O_TRYK_ZARATAKI2: Uniform_Base
	{
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
	...
	class O_TRYK_ZARATAKI3: Uniform_Base
	{
		scope = 2;
        scopeCurator = 0;
        scopeArsenal = 0;
